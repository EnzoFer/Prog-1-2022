            ...
            for key, value in filters:
                ...
                if key == "sort_by":
                    ...
                    if value == "calification":
                        poems = poems.outerjoin(PoemModel.califications).group_by(PoemModel.id).order_by(func.avg(PoemModel.puntaje))
                
                    if value == "calification[desc]":
                        poems = poems.outerjoin(PoemModel.califications).group_by(PoemModel.id).order_by(func.avg(PoemModel.puntaje).desc())
